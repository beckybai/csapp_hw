...
int gen_need_valC()
{
    return ((if_id_next->icode) == (I_IRMOVL) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_JMP) || (if_id_next->icode) == (I_CALL) || 
      (if_id_next->icode) == (I_RMCHANGE) || (if_id_next->icode) == 
      (I_IADDL));
}
...
int gen_d_srcA()
{
    return (((if_id_curr->icode) == (I_RRMOVL) || (if_id_curr->icode) == 
        (I_RMMOVL) || (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode)
         == (I_PUSHL) || (if_id_curr->icode) == (I_RMCHANGE)) ? 
      (if_id_curr->ra) : ((if_id_curr->icode) == (I_LEAVE)) ? (REG_EBP) : (
        (if_id_curr->icode) == (I_POPL) || (if_id_curr->icode) == (I_RET))
       ? (REG_ESP) : (REG_NONE));
}
...
int gen_d_srcB()
{
    return (((if_id_curr->icode) == (I_ALU) || (if_id_curr->icode) == 
        ...
        (I_RMCHANGE)) ? (if_id_curr->rb) : ((if_id_curr->icode) == 
...
int gen_d_dstM()
{
    return (((if_id_curr->icode) == (I_MRMOVL) || (if_id_curr->icode) == 
        (I_POPL) || (if_id_curr->icode) == (I_RMCHANGE)) ? (if_id_curr->ra)
       : ((if_id_curr->icode) == (I_LEAVE)) ? (REG_EBP) : (REG_NONE));
}
...
int gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVL) || (id_ex_curr->icode) == 
        ...
        (id_ex_curr->icode) == (I_RMCHANGE)) ? (id_ex_curr->valc) : (
...
int gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
        ...
        (I_LEAVE) || (id_ex_curr->icode) == (I_RMCHANGE)) ? 
...
int gen_mem_addr()
{
    return (((ex_mem_curr->icode) == (I_RMMOVL) || (ex_mem_curr->icode) == 
        ...
        (I_RMCHANGE)) ? (ex_mem_curr->vale) : ((ex_mem_curr->icode) == 
...
int gen_mem_read()
{
    return ((ex_mem_curr->icode) == (I_MRMOVL) || (ex_mem_curr->icode) == 
      (I_POPL) || (ex_mem_curr->icode) == (I_RET) || (ex_mem_curr->icode)
       == (I_LEAVE) || (ex_mem_curr->icode) == (I_RMCHANGE));
}
...
int gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          ...
          (if_id_curr->icode) || (I_RET) == (id_ex_curr->icode) || (I_RET)
           == (ex_mem_curr->icode))) | ((id_ex_curr->icode) == (I_RMCHANGE)
        ));
}
...
int gen_D_stall()
{
    return ((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          ...
          (id_ex_curr->destm) == (id_ex_next->srca) || (id_ex_curr->destm)
           == (id_ex_next->srcb))) | ((id_ex_curr->icode) == (I_RMCHANGE)))
    ;
}
...
int gen_D_bubble()
{
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | (!(((id_ex_curr->icode) == (I_RMCHANGE)) | (((id_ex_curr->icode)
