...
# Instruction code for remove and set value instruction
intsig IRMCHANGE 'I_RMCHANGE'
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL,IIADDL,ILEAVE,IRMCHANGE};
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL,IIADDL,IRMCHANGE };

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IRMCHANGE,IIADDL };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL,IRMCHANGE  } : D_rA;
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL,IIADDL,IRMCHANGE  } : D_rB;
	D_icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
	D_icode in { ILEAVE } : REBP; # POP instruction
	1 : RNONE;  # Don't need register
];
...
int d_dstM = [
	D_icode in { IMRMOVL, IPOPL,IRMCHANGE } : D_rA;
	D_icode in { ILEAVE } : REBP; #Things read from stack are stored in the %ebp
	1 : RNONE;  # Don't write any register
];
...
int d_valB = [
	d_srcB == e_dstE : e_valE;    # Forward valE from 
	d_srcB == M_dstM : m_valM;    # Forward valM muuuuemory
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL,IIADDL,IRMCHANGE } : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL,IIADDL,ILEAVE,IRMCHANGE } : E_valB;
...
int mem_addr = [
	M_icode in { IRMMOVL, IPUSHL, ICALL, IMRMOVL,IRMCHANGE } : M_valE;
	M_icode in { IPOPL, IRET, ILEAVE } : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVL, IPOPL, IRET , ILEAVE,IRMCHANGE };

## Set write control signal
bool mem_write = M_icode in { IRMMOVL, IPUSHL, ICALL, IRMCHANGE };
...
bool D_bubble =
	...
	!(E_icode in {IRMCHANGE} || E_icode in { IMRMOVL, IPOPL, ILEAVE } && E_dstM in { d_srcA, d_srcB }) &&
	  IRET in { D_icode, E_icode, M_icode };
